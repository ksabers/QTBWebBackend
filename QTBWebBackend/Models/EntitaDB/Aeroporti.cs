...
public partial class Aeroporti
{
    ...
    public virtual ICollection<Persone> Persone { get; } = new List<Persone>();

    public virtual TipiAeroporti TipoAeroportoNavigation { get; set; }

    public virtual ICollection<Voli> VoliAeroportoFineNavigation { get; } = new List<Voli>();

    public virtual ICollection<Voli> VoliAeroportoInizioNavigation { get; } = new List<Voli>();
}